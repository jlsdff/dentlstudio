...
export default function EmergencyDentistry() {
    ...
    const title = " Dimpled Chin"
    const description = " Say goodbye to the “orange peel” texture with muscle-relaxing injectables that create a smoother, more balanced chin appearance—instantly elevating your profile."
    ...
    return (
        <>
            <Head title=" Dimpled Chin Treatment in Clyde North">
                ...
                <section className="text-stone-950 bg-soft-200 p-8 md:p-16  tracking-widest
                    ...
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        ...
                        <p className="text-base">
                            The Dimpled Chin treatment uses targeted anti-wrinkle injections to relax the mentalis muscle, which is responsible for chin dimpling or an uneven “pebble-like” texture when talking or moving the lower face.
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">Who is it for?</h2>
                        <p className="text-base">
                            Ideal for individuals who notice a textured or puckered chin at rest or during facial expressions, especially when it affects facial balance or confidence.
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">How it works:</h2>
                        <p className="text-base">
                            A few precise injections are administered into the mentalis muscle to reduce overactivity. This relaxes the chin and smooths out dimples or creases while maintaining natural movement.
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">Expected results:</h2>
                        <p className="text-base">
                            Results typically appear within 3–5 days, with full smoothing effect by two weeks. Effects usually last 3–4 months and may improve further with regular treatments.
                        </p>
                    </div>
                </section>
                ...
                <section className="text-stone-950 bg-soft-200 p-8 md:pb-16 md:px-16 mb:pt-0 tracking-widest" >
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 ">
                        <li className="flex items-center gap-2">
                            ...
                            Smooths dimpled or pebbled chin texture
                        </li>
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                            Creates a more youthful, polished appearance
                        </li>
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                            Enhances lower-face harmony
                        </li>
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                        ...
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                            Natural-looking results without stiffness
                        </li>
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
