...
export default function EmergencyDentistry() {
    ...
    const title = " Masseters / Jaw Slimming"
    const description = " Achieve a softer, more contoured lower face with this non-surgical treatment that relaxes overactive jaw muscles—perfect for facial slimming and teeth grinding relief."
    ...
    return (
        <>
            <Head title=" Masseter Reduction & Jaw Slimming Treatment">
                ...
                <section className="text-stone-950 bg-soft-200 p-8 md:p-16  tracking-widest
                    ...
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        ...
                        <p className="text-base">
                            Masseter treatment involves targeted muscle relaxant injections into the masseter muscles (located at the sides of the jaw). It’s designed to reduce muscle bulk and soften the appearance of a square or wide jawline, while also alleviating symptoms of teeth grinding (bruxism).
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">Who is it for?</h2>
                        <p className="text-base">
                            Ideal for individuals with a strong, wide lower face due to overdeveloped jaw muscles, or for those who suffer from jaw tension, clenching, or nighttime grinding.
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">How it works:</h2>
                        <p className="text-base">
                            Muscle relaxants are carefully injected into the masseter muscles, gradually reducing their size over a few weeks. This leads to a slimmer jawline and helps relieve pressure from jaw tension or grinding.
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">Expected results:</h2>
                        <p className="text-base">
                            Facial slimming becomes noticeable in 4–6 weeks and lasts around 4–6 months. Patients often report a more feminine or V-shaped facial contour and reduced clenching discomfort.
                        </p>
                    </div>
                </section>
                ...
                <section className="text-stone-950 bg-soft-200 p-8 md:pb-16 md:px-16 mb:pt-0 tracking-widest" >
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 ">
                        <li className="flex items-center gap-2">
                            ...
                            Slims and contours a square jawline
                        </li>
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                            Treats teeth grinding and jaw tension
                        </li>
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                        ...
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                            Can improve sleep and reduce jaw pain
                        </li>
                    </ul>
