...
export default function EmergencyDentistry() {
    ...
    const title = " Nefertiti Neck Lift / Platysmal Bands"
    const description = " Redefine your jawline and soften visible neck bands with this non-invasive treatment designed to restore elegance and contour—no surgery required."
    ...
    return (
        <>
            <Head title=" Nefertiti Neck Lift & Platysmal Bands Treatment">
            ...
            <main>
                ...
                <section className="text-stone-950 bg-soft-200 p-8 md:p-16  tracking-widest
                    ...
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        ...
                        <p className="text-base">
                            The Nefertiti Neck Lift is a cosmetic injectable procedure that targets the platysmal muscles in the neck to relax tension and lift the lower face. Inspired by the famously elegant profile of Queen Nefertiti, this treatment smooths neck lines and subtly sculpts the jawline.
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">Who is it for?</h2>
                        <p className="text-base">
                            This treatment is ideal for individuals noticing sagging skin around the jaw and neck, prominent platysmal bands (vertical neck cords), or early signs of jowling who want a refreshed look without surgery.
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">How it works:</h2>
                        <p className="text-base">
                            Small doses of muscle relaxants are injected along the platysma and lower jawline. This reduces downward muscle pull and allows the upper face to naturally lift the lower features, improving definition.
                        </p>
                    </div>
                    <div className="p-4 rounded-xl border border-soft-300 bg-gradient-to-tr from-soft-200 to-soft-300 shadow-md">
                        <h2 className="text-lg md:text-xl font-semibold ">Expected results:</h2>
                        <p className="text-base">
                            You can expect a firmer, more defined jawline and a smoother neck contour within 5–10 days. Results typically last 3–4 months and improve with consistent treatments.
                        </p>
                    </div>
                </section>
                ...
                <section className="text-stone-950 bg-soft-200 p-8 md:pb-16 md:px-16 mb:pt-0 tracking-widest" >
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 ">
                        ...
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                            Non-surgical alternative to a lower facelift
                        </li>
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                            Subtle, natural lift to the lower face
                        </li>
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                        ...
                        <li className="flex items-center gap-2">
                            <ChevronRight size={18} />
                            Boosts confidence in your profile
                        </li>
                    </ul>
